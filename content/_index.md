...
## Layanan Kami
<img src="https://images.unsplash.com/photo-1454165804606-c3d57bc86b40?q=80&w=2070&auto=format&fit=crop&ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D" style="width: 100%; object-fit: cover; height: 300px" > -->
...
<body id="iau9">
  ...
  <div id="irz7b" class="gjs-grid-row">
    <div id="iycz3" class="gjs-grid-column">
      <h1 id="irjua" class="gjs-heading">Kami <span id="i4jn1p" class="gjs-text-blue">Percaya</span></h1>
      <div id="itndw" class="text-main-content">
        Kami percaya bahwa kekuatan teknologi dapat dimanfaatkan oleh <b>semua organisasi</b> di seluruh dunia untuk mendukung <b>perkembangan bisnis</b> mereka. Dengan senang hati, kami siap membantu Anda dalam <b>Transformasi Digital</b> dan mengembangkan <b>Sumber Daya Manusia (SDM)</b> ke tingkat yang lebih tinggi.
        <br/>
      </div>
      <a id="iar3s" class="gjs-button">
        Konsultasi Gratis
      </a>
    ...
    <div id="imymf" class="gjs-grid-column">
      <div id="ib541" class="gjs-grid-row">
        <div id="iz8m8" class="gjs-grid-column">
          <h4 id="ij2gh" class="gjs-heading gjs-text-blue">Simplcity & Efficiency ERP Platform</h4>
          <h2 id="ism014" class="gjs-heading">We Bring Data Closer To You</h2>
          <div id="igrx8" class="text-main-content">Kami membawa DATA lebih dekat kepada Anda, memberdayakan Anda untuk membuat keputusan yang informatif.</div>
          <a id="iqx3z1" class="gjs-button">
            Hubungi Kami</a>
        </div>
  ...
  <div id="ioyxg" class="gjs-grid-row">
    <div id="i8w4i" class="gjs-grid-column">
      <h4 id="ihs4lb" class="gjs-heading gjs-text-blue">Layanan Kami</h4>
      <h2 id="iiacm" class="gjs-heading">Kami Melayani Dengan
        <span id="icxfor" class="gjs-text-blue">Sepenuh Hati</span></br>
        <span id="icxfor" class="gjs-text-blue">Menjadi Partner</span>
  ...
  <div id="testimonial-section" class="gjs-grid-row">
    <div id="infwen" class="gjs-grid-column">
      ...
      <div id="i6fjjy" class="text-main-content">Kami memberikan apresiasi yang terdalam bagi </br>mereka yang telah percaya kepada kami.</div>
      <div id="i5k4nf" class="gjs-grid-row">
        <div id="inea73" class="gjs-grid-column testimonial-item">
          ...
          <div id="it3yug" class="text-main-content">
            This is the right place to seek a help for companies set up AWS servers. They can provide input and work very quickly, besides that ETHERVAL can also conduct training clearly and use easy-to-understand language. Overall very satisfied with the service and highly recommended!
          </div>
        </div>
        <div id="idndjn" class="gjs-grid-column testimonial-item">
          ...
          <div id="i8gt4n" class="text-main-content">
            They was helping us on analyzing our server architecture when we were having a bottleneck issue on our server. Not only that, at the end of the session, They helped us by providing us comprehensive report about the problems and the suggestions to be taken in order to make our server more scalable in the future.
          </div>
        </div>
      </div>
    </div>
  ...
  <div id="iz29ek" class="gjs-grid-row">
    <div id="ik2rdi" class="gjs-grid-column">
      <h2 id="i83vu9" class="gjs-heading">Mari Kami Dukung Anda Dalam</br>
        <span id="i7owfh" class="gjs-text-blue">Transformasi Digital</span></h2>
      <div id="in201n" class="text-main-content">
        Dapatkan layanan konsultasi gratis untuk memulai perjalanan transformasi digital Anda
        <br/>
        Karena perkembangan bisnis Anda adalah jalan misi kami
      </div>
      <a id="iwgwt5" class="gjs-button">Konsultasi Gratis</a>
    </div>
  </div>  
</body>
